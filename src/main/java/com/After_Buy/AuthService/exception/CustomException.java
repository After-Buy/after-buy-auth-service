...
public class CustomException extends RuntimeException {
    ...
    /**
     * 자원 찾기 실패, 레코드 누락, 권한 상실 등에 사용하는 낫파운드 널 회피성 예외 발행기
     *
     * @param message : 이미 탈퇴 연산이 들어간 계정이거나 존재하지도 않는 리소스를 호출할 때의 알럿 문구
    ...
    /**
     * 서버 망 분리, 외부(카카오/AWS) 의존성 이슈 등 개발자나 머신 자체의 셧다운 대응 발생 예외 생성기
     *
