package com.After_Buy.AuthService.exception;

import com.After_Buy.AuthService.client.AdminInternalClient;
...
public class GlobalExceptionHandler {
    ...
    /**
     * 리퀘스트 바디 맵핑 및 밸리데이션(Valid 정규식) 규정 침해 실패 핸들링 대응 함수
     ...
     * 시스템 예측망을 이탈한 치명적인 NULL 포인트 결함이나 데이터베이스 물리 단절 등이 발생 시 시스템 내부 마비 증거를 500 응답으로 둔갑시킵니다.
